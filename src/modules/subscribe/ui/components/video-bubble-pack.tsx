...
export default function VideoBubblePack({
    ...
    const {data: channels = [], isLoading} = useGetSubscribedChannelsQuery(channelId);
    ...
    if (isLoading) {
        return <p className="text-center">Loading channels...</p>;
    }

    return (
        <>
            {/* search input */}
            <div className="absolute top-20 left-1/2 z-50">
                <input
                    type="text"
                    ...
                    {activeBubble && (
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    className="absolute bottom-4 left-4 z-10 backdrop-blur-md bg-white/10 text-blue p-4 rounded-lg shadow-md max-w-[80%]">
